const typeColors = {
    bug: 'linear-gradient(0deg, rgba(102,145,51,1) 0%, rgba(113,159,64,1) 55%)',
    dragon: 'linear-gradient(0deg, rgba(64,150,188,1) 0%, rgba(83,164,207,1) 55%)',
    fairy: 'linear-gradient(0deg, rgba(224,154,199,1) 0%, rgba(240,186,214,1) 55%)',
    fire: 'linear-gradient(0deg, rgba(224,108,30,1) 0%, rgba(244,124,39,1) 55%)',
    ghost: 'linear-gradient(0deg, rgba(101,80,147,1) 0%, rgba(123,99,164,1) 55%)',
    ground: 'linear-gradient(0deg, rgba(219,184,58,1) 0%, rgba(247,222,63,1) 55%)',
